...
const Floor1 = () => {
  ...
  const RoomSVG = [
    { id: 'HALL', x: 1, y: 172, width: 727, height: 255, room_type: 'lroom' }, { id: 'R111', x: 221, y: 306, width: 146, height: 121, room_type: 'lroom' },
    { id: 'M03', x: 221, y: 750, width: 146, height: 164, room_type: 'room' }, { id: 'M04', x: 221, y: 588, width: 146, height: 162, room_type: 'room' }, 
    { id: 'M05', x: 221, y: 427, width: 146, height: 161, room_type: 'lroom' },{ id: 'M21', x: 582, y: 750, width: 146, height: 164, room_type: 'room' }, 
    { id: 'M22', x: 582, y: 588, width: 146, height: 162, room_type: 'room' }, { id: 'M23', x: 582, y: 427, width: 146, height: 162, room_type: 'room' },
    { id: 'COMMON', x: 221.5, y: 2, width: 190, height: 170, room_type: 'lroom' }, { id: 'AUDITORIUM', x: 1, y: 427, width: 200, height: 162, room_type: 'room' },
    { id: 'M13', x: 397, y: 608, width: 78, height: 77, room_type: 'lroom' }, { id: 'M12', x: 397, y: 531, width: 78, height: 77, room_type: 'lroom' },
    { id: 'M15', x: 397, y: 761, width: 78, height: 77, room_type: 'lroom' }, { id: 'M14', x: 397, y: 684, width: 78, height: 77, room_type: 'lroom' },
      ...
      const updateRoomColor = () =>{
        if (document.getElementById(room.id) != null) {
          ...
          if (element) {
            ...
            if(GeneralRoom.includes(room.id) || room.id == 'HALL' || room.id == 'COMMON'){
