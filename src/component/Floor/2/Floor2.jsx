...
const Floor2 = () => {
  ...
  const RoomSVG = [
    { id: '203', x: 1, y: 745, width: 146, height: 171, room_type:'room'},
    { id: '205', x: 1, y: 576, width: 146, height: 169, room_type:'room'},{ id: '207', x: 1, y: 407, width: 146, height: 170, room_type:'room'},
    { id: '215', x: 1, y: 1, width: 146, height: 202, room_type:'lroom'},
    { id: 'Project Base1', x: 364, y: 670, width: 145, height: 244, room_type:'room'},
    // { id: '223', x: 364, y: 770, width: 145, height: 144, room_type:'room'},{ id: '224', x: 364, y: 670, width: 145, height: 100, room_type:'room'},
    { id: 'Project Base2', x: 364, y: 426, width: 145, height: 244, room_type:'room'},
    // { id: '225', x: 364, y: 570, width: 145, height: 100, room_type:'room'},{ id: '226', x: 364, y: 426, width: 145, height: 144, room_type:'room'},
    // <rect x="147" y="108" width="146" height="107" transform="rotate(-180 147 108)" fill="white" stroke="black"/>

    { id: 'PT1', x: 257, y: 606, width: 79, height: 50, room_type:'sroom'},{ id: 'PT2', x: 257, y: 656, width: 79, height: 50, room_type:'sroom'},{ id: 'PT3', x: 257, y: 706, width: 79, height: 50, room_type:'sroom'},
    { id: 'C2', x: 178, y: 756, width: 158, height: 81, room_type:'sroom'},{ id: 'C1', x: 178, y: 606 , width: 79, height: 150, room_type:'sroom'},
