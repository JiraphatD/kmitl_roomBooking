...
import BookerRolesCounterDisplay from './BookerRoles/BookerRolesCounterDisplay'
    ...
    <div style={
      ...
      <Grid container spacing={2}>
        <Grid item xl={12} lg={12} md={12} sm={12} xs={12} sx={{ marginTop: '1rem' }}>
          <h2><b>ระบบการจัดการห้องและการจอง</b></h2>
        </Grid>
        <Grid item xl={7} lg={7} md={7} sm={12} xs={12}>
          <Grid container spacing={2} >
            <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
              <CardSumary card_name={'การจองทั้งหมด'} quantity={roomBook.length} icon={'EventIcon'} />
            </Grid>
            <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
              <CardSumary card_name={'ผู้จองทั้งหมด'} quantity={bookerData.length} icon={'GroupsIcon'} />
            </Grid>
            <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
              <CardSumary card_name={'การยืนยันอนุมัติ'} quantity={approvementList.length} icon={'CheckCircleIcon'} />
            </Grid>
            <Grid item xl={6} lg={6} md={6} sm={6} xs={12}>
              <CardSumary card_name={'การเพิกถอน'} quantity={rejectedList.length} icon={'CancelIcon'} />
            </Grid>
